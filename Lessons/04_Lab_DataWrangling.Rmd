...
df.1999<- filter(NTL.phys.data, year4==1999)

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.

df.90s<- filter(NTL.phys.data, year4 %in% c(1990:1999) & lakename == "Tuesday Lake")


```
Question: Why don't we filter using row numbers?

> Answer: Could create reproducibility problems once we start rearranging/adding columns.
