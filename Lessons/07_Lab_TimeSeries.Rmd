...
BRA_Rainfall_ts <- ts(BRA_complete$Rainfall, start = c(1901,1), frequency = 12)
BRA_Temp_Ts<-ts(BRA_complete$Temperature_C, start=c(1901,1), frequency = 12)
...
BRA_Rainfall_Decomposed <- stl(BRA_Rainfall_ts, s.window = "periodic")
BRA_Temp_Decomposed <- stl(BRA_Temp_Ts, s.window = "periodic")
...
BRA_Rainfall.late_Components <- as.data.frame(BRA_Rainfall_Decomposed$time.series[,1:3])
BRA_Temp.late_Components <- as.data.frame(BRA_Temp_Decomposed$time.series[,1:3])

BRA_Rainfall.late_Components  <- mutate(BRA_Rainfall.late_Components ,
