...
```{r}
ggplot(litter)+
  geom_boxplot(aes(x=functionalGroup, y=dryMass, fill=functionalGroup, color=functionalGroup))

ggplot(litter)+
  geom_violin(aes(x=dryMass, y=functionalGroup, color=functionalGroup, fill=functionalGroup))
```
