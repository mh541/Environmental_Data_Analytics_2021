...
> Answer: The graph and the seasonal Mann Kendall test suggest there is a seasonal trend in this dataset.
...
```{r}
#15
Ozone_Components <- as.data.frame(GaringerOzone.monthly.Decomposed$time.series[,1:3])

Ozone_Components <- mutate(Ozone_Components,
        Observed =GaringerOzone.monthly$`mean(Concentrations_Clean)`,     
...
> Answer: In terms of the research questions, we would accept the null and say that ozone levels have not changed at this stations throughout the 2010s.
