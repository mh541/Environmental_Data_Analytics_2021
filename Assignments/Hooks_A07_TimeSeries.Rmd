...
> Answer: Yes, since the p-value is 0.04 (less than 0.05), we reject the null hypothesis and conclude that there is a seasonal trend in this series.
...
> Answer: The graph and the seasonal Mann Kendall test suggest there is a seasonal trend in this dataset. None of the seasons are statistically significant. 
...
GaringerOzone.monthly.noseason <- GaringerOzone.monthly.Decomposed$time.series[,2:3]
...
> Answer: The score of -16300 suggests a overall downward trend.  In terms of the research questions, we would reject the null hypothesis and say that because the p-value is less than 0.05 (2.22e-16), there is a monotonic trend.
